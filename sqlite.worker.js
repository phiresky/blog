...
class LazyUint8Array {
    ...
    getter(chunkNum) {
        ...
        if (typeof this.chunks[chunkNum] === "undefined") {
            ...
            for (let i = 0; i < chunksToFetch; i++) {
                ...
                const curSize = (i + i) * this.chunkSize > buf.byteLength
    ...
    checkServer() {
        ...
        if (!hasByteServing)
            throw Error("server does not support byte serving");
    ...
    doXHR(absoluteFrom, absoluteTo) {
        console.log(`- [xhr of size ${(absoluteTo + 1 - absoluteFrom) / 1024} KiB]`);
...
const sql_wasm_js_1 = __importDefault(__webpack_require__(/*! ../sql.js/dist/sql-wasm.js */ "./sql.js/dist/sql-wasm.js"));
const sql_wasm_wasm_1 = __importDefault(__webpack_require__(/*! ../sql.js/dist/sql-wasm.wasm */ "./sql.js/dist/sql-wasm.wasm"));
...
const mod = {
    db: null,
    sqljs: null,
    async SplitFileHttpDatabase(wasmUrl, p) {
        if (this.db)
