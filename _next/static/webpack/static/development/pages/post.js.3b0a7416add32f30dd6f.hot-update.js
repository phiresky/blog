...
function TooltipLink(_ref) {
  ...
  if (attrs["cite-meta"]) {
    ...
    return __jsx("a", {
      ...
      id: id,
      className: "jsx-".concat(style.__hash) + " " + (clazz.join(" ") + " tooltip" || false)
